...
async def generate_stream(protocol_msg: ProtocolMessage, history: list):
    start_time = time.time()

    # Prepare user prompt
    prompt = USER_MESSAGE_PROTOCOL_HEAD_TEMPLATE + PromptTemplate(
        input_variables=["USER_MESSAGE_REF_PROTOCOL"],
        template=USER_MESSAGE_PROTOCOL_TAIL_TEMPLATE,
