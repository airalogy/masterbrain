...
def _resolve_web_dist_dir() -> Path | None:
    ...
    if package_root.name == "masterbrain" and package_root.parent.name == "packages":
        repo_candidates.append(package_root.parent.parent / "apps" / "studio" / "dist")

    if package_root.name == "api" and package_root.parent.name == "apps":
        repo_candidates.extend(
            [
                package_root.parent / "studio" / "dist",
                package_root.parent / "web" / "dist",
            ]
        )
